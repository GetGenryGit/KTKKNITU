...
public class HistoryOfDoingVM : IHistoryOfDoingVM
{
    #region [Constructors]
    private IDisplayAlertService displayAlertService;
    private IHttpService httpService;
    public HistoryOfDoingVM(IDisplayAlertService displayAlertService,
    ...
    *//*private async Task<APIResponse> GetHistoryAdmin()
    ...
    public async Task UpdateHistoryList()
    {
        try
        {
            ...
            APIResponse response = await GetHistoryAdmin();
