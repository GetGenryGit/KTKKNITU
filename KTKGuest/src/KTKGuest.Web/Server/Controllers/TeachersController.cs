...
public class TeachersController : ControllerBase
{
    ...
    public IActionResult GetAll()
    {
        ...
        try
        {
            ...
            response.Result = true;
            response.Message = "Справочники активных и неактивных учителей успешно получены!";
        ...
        catch (Exception ex)
        {
            ...
            response.Message = ex.Message;
#else
            response.Message = "Произошла ошибка на стороне сервера, при получение справочников активных и неактивных учителей!";
#endif
            return BadRequest(response);
        }
    }
    ...
    public IActionResult Add([FromForm] Dictionary<string,string> postForm)
    {
        ...
        try
        {
            ...
            using (var conn = new NpgsqlConnection(_connectionString))
            {
                ...
                query = "INSERT INTO logs(event_describe, role_id) " +
                        "VALUES('Справочник учителей успешно синхронизирован!', (SELECT id FROM roles WHERE title = 'О.Р.')); ";
        ...
        catch (Exception ex)
        {
            using (var conn = new NpgsqlConnection(_connectionString))
            {
                ...
                string query;
                query = "INSERT INTO logs(event_describe, role_id) " +
                        "VALUES('При синхронизации справочника учителей произошел сбой!', (SELECT id FROM roles WHERE title = 'О.Р.')); ";
